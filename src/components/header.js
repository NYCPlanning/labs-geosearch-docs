        ...
        <div className="grid-x grid-padding-x">
          <div className="branding cell shrink large-auto">
            ...
            <Link to="/" className="site-name">
              GeoSearch <small className="site-subtitle show-for-medium">Authoritative <span className="show-for-large">Search</span> Results for N<span className="show-for-xlarge">ew </span>Y<span className="show-for-xlarge">ork </span>C<span className="show-for-xlarge">ity</span> Addresses</small>
            </Link>
          </div>
